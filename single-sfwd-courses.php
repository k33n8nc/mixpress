...
<div class="bg-primary w-full sticky top-[56px] z-30">
			...
			<div class="flex items-center w-full lg:w-2/3 pt-4 lg:pr-20 text-white">
				...
				<div class="flex items-center	mr-6">
					<div class="text-white rounded-full flex items-center justify-center text-sm px-4 py-2" style="background: rgba(0,0,0,0.1);" >
						...
						<p class="text-sm"><?php echo get_post_custom_values('lms_course_chapters')[0]; ?> <span class="hidden lg:inline">hoofdstukken</span></p>
					</div>					
				</div>

				<div class="flex items-center	mr-6">
					<div class="text-white rounded-full flex items-center justify-center text-sm px-4 py-2" style="background: rgba(0,0,0,0.1);" >
						<i class="mr-2 fas fa-book-reader"></i>
						<p class="text-sm"><?php echo get_post_custom_values('lms_course_assignments')[0]; ?> <span class="hidden lg:inline">opdrachten</span></p>
					</div>
				</div>
				...
				<div class="flex items-center	">
					<div class="text-white rounded-full flex items-center justify-center text-sm px-4 py-2" style="background: rgba(0,0,0,0.1);" >
						...
						<p class="text-sm"><?php echo get_post_custom_values('lms_course_est_time')[0]; ?></p>
